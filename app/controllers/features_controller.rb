class FeaturesController < ApplicationController
  ...
  add_breadcrumb 'Features', :features_path, except: [:index]
  ...
  private
    ...
    def set_feature
      ...
      add_breadcrumb @feature.name, feature_path(@feature)
    end

    # Only allow a list of trusted parameters through.
    def feature_params
      params.require(:feature).permit(:name, :summary, :released_on, :content)
    end
end
