...
ActiveRecord::Schema[7.0].define(version: 20_220_702_121_835) do
  ...
  create_table 'comments', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[commentable_id commentable_type user_id], name: 'index_on_commentable_and_user'
    t.index %w[commentable_id commentable_type], name: 'index_on_commentable'
  ...
  create_table 'notifications', force: :cascade do |t|
    ...
    t.index %w[group_type group_id], name: 'index_notifications_on_group'
    t.index %w[notifiable_type notifiable_id], name: 'index_notifications_on_notifiable'
    t.index %w[notifier_type notifier_id], name: 'index_notifications_on_notifier'
  ...
  create_table 'notifications_subscriptions', force: :cascade do |t|
    ...
    t.index %w[target_type target_id key], name: 'index_subscriptions_on_target_type_id_and_key', unique: true
    t.index %w[target_type target_id], name: 'index_notifications_subscriptions_on_target'
  end
