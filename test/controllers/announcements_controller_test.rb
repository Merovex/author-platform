  ...
  test 'should create announcement' do
    assert_difference('Announcement.count') do
      post announcements_url,
           params: { announcement: { announceable_id: @announcement.announceable_id,
                                     announceable_type: @announcement.announceable_type, published_at: @announcement.published_at, summary: @announcement.summary, title: @announcement.title } }
    end
